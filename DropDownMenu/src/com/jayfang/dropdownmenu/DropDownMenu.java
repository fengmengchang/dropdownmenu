...
public class DropDownMenu extends LinearLayout{
    ...
    private List<ImageView> mIvMenuArrowBottom=new ArrayList<ImageView>();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mPopupWindow==null){
        	Log.e("onDraw", "mPopupWindow==null");
            ...
            mMenuList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    mIvMenuArrowBottom.get(ColumnSelected).setVisibility(View.GONE);
        	...
        	if(isrefresh){
        		Log.e("onDraw", "mPopupWindow!=null");
        		MenuAdapters=new ArrayList<MenuListAdapter>();
        		mRlMenuBacks.clear();
        		mTvMenuTitles.clear();
        		mRlMenuBacks.clear();
        		mIvMenuArrowBottom.clear();
        		mIvMenuArrow.clear();
        		isrefresh = false;
        		refresh();
        	}
    ...
    private void refresh(){
         ...
         for (int i=0;i<MenuCount;i++){
             ...
             ImageView ivbt=(ImageView)v.findViewById(R.id.iv_menu_arrow_bottom);
             mIvMenuArrowBottom.add(ivbt);
             ...
             v.setOnClickListener(new OnClickListener() {
                 ...
                 public void onClick(View view) {
                     ...
                     mIvMenuArrowBottom.get(ColumnSelected).setVisibility(View.VISIBLE);
